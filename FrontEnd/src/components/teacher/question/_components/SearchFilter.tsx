...
interface QuestionSearchFilterProps {
  queryParams?: Partial<QuestionQuery>;
  onParamsChange?: (params: Partial<QuestionQuery>) => void;
}

const DEFAULT_PARAMS: QuestionQuery = {
  PageNumber: 1,
  PageSize: 10,
  Search: "",
...
export default function SearchFilter({
  ...
  const hasActiveFilters =
    !!localParams.Search ||
    localParams.QuestionType !== undefined ||
      ...
      <div className="flex flex-col lg:flex-row gap-3 items-end">
        ...
        <div className="w-full lg:w-[200px]">
          <select
            ...
            value={localParams.QuestionType ?? ""}
            onChange={(e) =>
              updateLocalParam("QuestionType", e.target.value || undefined)
            }
          >
            <option value="">Tất cả loại câu hỏi</option>
            <option value="1">Nhiều đáp án đúng</option>
            <option value="2">Một đáp án đúng</option>
