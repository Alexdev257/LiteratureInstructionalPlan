...
public class PracticequestionCreateCommand : IRequest<PracticeQuestionCreateResponse>,
    IValidatable<PracticeQuestionCreateResponse>
{
    ...
    {
        var response = new PracticeQuestionCreateResponse();
