...
public class PracticequestionUpdateCommand : IRequest<PracticeQuestionUpdateResponse>,
    IValidatable<PracticeQuestionUpdateResponse>
{
    ...
    {
        var response = new PracticeQuestionUpdateResponse();
