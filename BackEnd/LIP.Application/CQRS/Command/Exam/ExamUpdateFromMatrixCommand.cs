...
{
    public class ExamUpdateFromMatrixCommand : IRequest<ExamUpdateFromMatrixResponse>, IValidatable<ExamUpdateFromMatrixResponse>
    {
        ...
        {
            ExamUpdateFromMatrixResponse response = new ExamUpdateFromMatrixResponse();
