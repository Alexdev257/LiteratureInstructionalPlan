...
{
    public class PracticequestionDeleteCommandHandler : IRequestHandler<PracticequestionDeleteCommand, PracticeQuestionDeleteResponse>
    {
        ...
        public async Task<PracticeQuestionDeleteResponse> Handle(PracticequestionDeleteCommand request, CancellationToken cancellationToken)
        {
            var question = await _practicequestionRepository.GetAsync(new PracticequestionGetQuery { QuestionId = request.QuestionId });
            if (question == null)
            {
