...
public class LoginCommandHandler : IRequestHandler<LoginCommand, LoginResponse>
{
    ...
    public LoginCommandHandler(IUserRepository userRepository, IJwtHelper jwtHelper, IBcryptHelper bcryptHelper,
        ISessionExtensions sessionExtensions, IRedisHelper redisHelper)
    {
