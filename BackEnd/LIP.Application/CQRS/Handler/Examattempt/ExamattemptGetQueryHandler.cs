...
public class ExamattemptGetQueryHandler : IRequestHandler<ExamattemptGetQuery, ExamAttempt?>
{
    ...
    public async Task<ExamAttempt?> Handle(ExamattemptGetQuery request, CancellationToken cancellationToken)
    {
